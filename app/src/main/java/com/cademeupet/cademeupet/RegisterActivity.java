...
public class RegisterActivity extends AppCompatActivity {
    ...
    public void registerUser(View view) {
        ...
        } else if (inputNumber.getText().toString().trim().equals("") || !android.util.Patterns.PHONE.matcher(inputNumber.getText().toString().trim()).matches() || !Pattern.matches("^[+]?[0-9]{8,14}$", inputNumber.getText().toString().trim())) {
